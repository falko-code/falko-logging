...
public readonly partial struct Logger
{
    ...
    public void Trace(DefaultInterpolatedStringHandler messageHandler)
    {
        ...
        {
            Log(in loggerContext, LogLevel.Trace, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Trace(Exception? exception, DefaultInterpolatedStringHandler messageHandler)
    {
        ...
        if (loggerContext.IsTraceLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Trace, exception, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Trace([Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsTraceLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Trace, message);
        }
    }
    ...
    public void Trace(Exception? exception, [Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsTraceLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Trace, exception, message);
        }
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Trace<T>(T messageArgument, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsTraceLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Trace,
                messageArgument, messageFactory);
        }
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Trace<T>(Exception? exception, T messageArgument, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsTraceLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Trace, exception,
                messageArgument, messageFactory);
        }
    }
