...
public readonly partial struct Logger
{
    ...
    public void Info(DefaultInterpolatedStringHandler messageHandler)
    {
        ...
        {
            Log(in loggerContext, LogLevel.Info, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Info(Exception? exception, DefaultInterpolatedStringHandler messageHandler)
    {
        ...
        if (loggerContext.IsInfoLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Info, exception, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Info([Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsInfoLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Info, message);
        }
    }
    ...
    public void Info(Exception? exception, [Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsInfoLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Info, exception, message);
        }
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Info<T>(T messageArgument, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsInfoLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Info,
                messageArgument, messageFactory);
        }
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Info<T>(Exception? exception, T messageArgument, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsInfoLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Info, exception,
                messageArgument, messageFactory);
        }
    }
