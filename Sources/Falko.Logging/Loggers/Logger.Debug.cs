...
public readonly partial struct Logger
{
    ...
    public void Debug(DefaultInterpolatedStringHandler messageHandler)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsDebugLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Debug, messageHandler.ToStringAndClear());
        }
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Debug(Exception? exception, DefaultInterpolatedStringHandler messageHandler)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsDebugLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Debug, exception, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Debug([Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsDebugLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Debug, message);
        }
    }
    ...
    public void Debug(Exception? exception, [Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsDebugLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Debug, exception, message);
        }
    }
    ...
    public void Debug<T>(T messageArgument, LogMessageFactory<T> messageFactory)
    {
        ...
        if (loggerContext.IsDebugLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Debug,
    ...
    public void Debug<T>(Exception? exception, T messageArgument, LogMessageFactory<T> messageFactory)
    {
        ...
        if (loggerContext.IsDebugLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Debug, exception,
                messageArgument, messageFactory);
        }
    }
