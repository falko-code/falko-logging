...
public readonly partial struct Logger
{
    ...
    public void Fatal(DefaultInterpolatedStringHandler messageHandler)
    {
        ...
        {
            Log(in loggerContext, LogLevel.Fatal, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Fatal(Exception? exception, DefaultInterpolatedStringHandler messageHandler)
    {
        ...
        if (loggerContext.IsFatalLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Fatal, exception, messageHandler.ToStringAndClear());
        }
    }
    ...
    public void Fatal([Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsFatalLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Fatal, message);
        }
    }
    ...
    public void Fatal(Exception? exception, [Localizable(false)][StructuredMessageTemplate] string? message)
    {
        ...
        if (loggerContext.IsFatalLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Fatal, exception, message);
        }
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Fatal<T>(T messageArgument, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsFatalLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Fatal,
                messageArgument, messageFactory);
        }
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public void Fatal<T>(Exception? exception, T messageArgument, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;

        if (loggerContext.IsFatalLevelEnabled)
        {
            Log(in loggerContext, LogLevel.Fatal, exception,
                messageArgument, messageFactory);
        }
    }
